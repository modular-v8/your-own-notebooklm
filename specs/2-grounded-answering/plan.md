...
|---|---|---|---|---|---|---|---|---|
| fb_rules | 27 | 82.6% | 50.0% | 78.3% | 0.645 | 80.0% | 0.0% | 72.5% |
...
- `fb_rules` refusal_correct_rate (50%, 2 of 4 `not-in-document` entries) has no Phase 1 comparison point (the gold set roughly tripled this phase); worth a first look before treating it as a baseline.
