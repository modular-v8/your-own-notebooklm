...
- [~] Grounded and refusal-correct rates on the four Markdown gold sets do not regress against Phase 1 -- refusal-correct held at 100% on all four; grounded_rate held on egear/smg but dropped on amg_mct (88.9%→77.8%) and tiptronic (100%→87.5%). Traced to judge-verdict flips on near-identical retrieved context and answer content across runs, not to the citation-instruction prompt -- see plan.md's as-built notes.
